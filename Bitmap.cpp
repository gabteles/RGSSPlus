...
namespace Plus {
         ...
         * @return void
         */
        void Bitmap::stretch_blt(Plus::Rect dest_rect, Plus::Bitmap src_bitmap, Plus::Rect src_rect){
            // TODO
        }
         ...
         * @return void
         */
        void Bitmap::stretch_blt(Plus::Rect dest_rect, Plus::Bitmap src_bitmap, Plus::Rect src_rect, unsigned char opacity){
            // TODO
        }
         ...
         * @return void
         */
        void Bitmap::fill_rect(int x, int y, unsigned int width, unsigned int height, Plus::Color color){
            // TODO
        }
         ...
         * @return void
         */
        void Bitmap::fill_rect(Plus::Rect rect, Plus::Color color){
            // TODO
        }
         ...
         * @return void
         */
        void Bitmap::gradient_fill_rect(int x, int y, unsigned int width, unsigned int height, Plus::Color color1, Plus::Color color2){
            // TODO
        }
         ...
         * @return void
         */
        void Bitmap::gradient_fill_rect(Plus::Rect rect, Plus::Color color1, Plus::Color color2){
            // TODO
        }
         ...
         * @return void
         */
        void Bitmap::clear_rect(int x, int y, unsigned int width, unsigned int height){
            // TODO
        }
         ...
         * @return void
         */
        void Bitmap::clear_rect(Plus::Rect rect){
            // TODO
        }
         ...
         */
        Plus::Color Bitmap::get_pixel(unsigned int x, unsigned int y){
            // TODO
         ...
         * @return void
         */
        void Bitmap::set_pixel(unsigned int x, unsigned int y, Plus::Color color){
            // TODO
        }
         ...
         * @param int Angle
         */
        void Bitmap::hue_change(int angle){
            // TODO
        }
         ...
         * @return void
         */
        void Bitmap::draw_text(int x, int y, unsigned int width, unsigned int height, string text){
            // TODO
        }
         ...
         * @param uint Height
         * @param std::string text
         * @param uchar Align (0 = Left | 1 = Center | 2 = Right)
         * @return void
         */
        void Bitmap::draw_text(int x, int y, unsigned int width, unsigned int height, string text, unsigned char align){
            // TODO
        }
         ...
         * @return void
         */
        void Bitmap::draw_text(Plus::Rect rect, string text){
            // TODO
        }
         ...
         * @return void
         */
        void Bitmap::draw_text(Plus::Rect rect, string text, unsigned char align){
            // TODO
        }
         ...
         */
        Plus::Rect Bitmap::text_size(string text){
            // TODO
        }
