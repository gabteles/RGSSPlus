...
namespace Plus {
     ...
     * @return void
     */
    void Bitmap::draw_text(int x, int y, unsigned int width, unsigned int height, std::string text){
        // TODO
    }
     ...
     * @return void
     */
    void Bitmap::draw_text(int x, int y, unsigned int width, unsigned int height, std::string text, unsigned char align){
        // TODO
    }
     ...
     * @return void
     */
    void Bitmap::draw_text(Plus::Rect rect, std::string text){
        // TODO
    }
     ...
     * @return void
     */
    void Bitmap::draw_text(Plus::Rect rect, std::string text, unsigned char align){
        // TODO
    }
     ...
     */
    Plus::Rect Bitmap::text_size(std::string text){
        // TODO
        return Rect(0,0,0,0);
    }
